...
import Logo from './logowheels4rent.png';
...
function Navbar() {
  ...
  return (
    <div
      id="navbar"
      className="bg-black flex justify-between items-center h-16 fixed top-0 w-full"
    >
      <nav
        id="navbar_links"
      ...
      >
        <li>
          <Link
            className="px-4 py-2 rounded-2xl transition-colors duration-150 ease-in border-none focus:outline-none text-white hover:bg-orange-500 hover:text-white"
            to="/"
          >
            Home
          </Link>
        ...
        {isAuthenticated() && (
          <li>
            <Link
              className="px-4 py-2 rounded-2xl transition-colors duration-150 ease-in border-none focus:outline-none text-white hover:bg-black hover:text-white"
